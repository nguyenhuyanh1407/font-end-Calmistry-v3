            ...
            <div className="brand-statement-list">
              {stats.map((item, i) => (
                <FadeInUp key={i} delay={i * 0.1}>
                  <div className="statement-item brand-statement-item mb-4 pb-4" style={{ 
                    borderBottom: i < stats.length - 1 ? '1px solid rgba(50, 77, 62, 0.1)' : 'none',
                    transition: 'all 0.3s ease'
                  }}>
                    <div className="d-flex align-items-start gap-3">
                      <div className="statement-icon mt-1" style={{ color: '#397a4a', transition: 'transform 0.3s ease' }}>
